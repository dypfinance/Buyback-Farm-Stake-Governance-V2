...
contract ConstantReturnStaking_BuyBack is Ownable {
    ...
    address public TRUSTED_DEPOSIT_TOKEN_ADDRESS; // the token which is deposited, and also used for rewards
    address public TRUSTED_PLATFORM_TOKEN_ADDRESS; // the token in which user claims or withdraws
    address public TRUSTED_STAKING_CONTRACT_ADDRESS;
